...
import { Col, Row } from 'choerodon-hap-ui';
          ...
          <Row>
            ...
            <Col md={6} sm={24} xs={24}>
              <div className="footer-center">
                ...
                <div>
                  <a target="_blank " href="https://github.com/choerodon/choerodon-hap-ui">
                    GitLab
                  </a>
                </div>
                <div>
                ...
                <div>
                  <a target="_blank" rel="noopener noreferrer" href="https://github.com/choerodon/choerodon-hap-ui/issues">
